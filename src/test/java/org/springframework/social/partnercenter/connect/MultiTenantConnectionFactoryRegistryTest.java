...
public class MultiTenantConnectionFactoryRegistryTest {
	...
	public static final String APPDIRECT_COM = "appdirect.com";
	public static final String GOOGLE_COM = "google.com";
	public static final String APPLE_COM = "apple.com";
	public static final String MICROSOFT_COM = "microsoft.com";
	...
	public void getConnectionFactory_whenCalled_returnsTheCorrectConnectionFactory(){
		...
		registry.addConnectionFactory(APPDIRECT_COM, new PartnerCenterConnectionFactory("", "", ""));
		registry.addConnectionFactory(GOOGLE_COM, new PartnerCenterConnectionFactory("", "", ""));
		registry.addConnectionFactory(APPLE_COM, new PartnerCenterConnectionFactory("", "", ""));
		registry.addConnectionFactory(MICROSOFT_COM, new PartnerCenterConnectionFactory("", "", ""));
