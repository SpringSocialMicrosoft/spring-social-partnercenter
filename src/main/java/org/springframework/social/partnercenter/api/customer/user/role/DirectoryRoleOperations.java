...
public interface DirectoryRoleOperations extends PagingResourceOperations<DirectoryRole> {
	ResponseEntity<PartnerCenterResponse<DirectoryRole>> getDirectoryRoles(String customerId);
	/**
	 ...
	 */
	ResponseEntity<PartnerCenterResponse<DirectoryRole>> getUserRoles(String customerId, String userId);
	ResponseEntity<PartnerCenterResponse<UserMember>> getUserMembersWithRole(String customerId, String roleId);
	/**
	 ...
	 */
	ResponseEntity<UserMember> addRoleToMember(String customerId, String roleId, UserMember userMember);
}
